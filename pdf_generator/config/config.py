...
class LaborBreakdownConfig(FieldConfig):
    ...
    def __init__(self, config, supp_config):
        ...
        self.base_labor_subtotal = ("base_labor_subtotal")
        self.social_security_tax_rate = ("social_security_tax_rate")
        self.medicare_tax_rate = ("medicare_tax_rate")
        self.unemployment_tax_rate = ("unemployment_tax_rate")
        self.workers_comp_insurance_rate = ("workers_comp_insurance_rate")
        self.liability_insurance_rate = ("liability_insurance_rate")
        self.total_taxes_and_insurance = ("total_taxes_and_insurance")
        self.direct_labor_subtotal = ("direct_labor_subtotal")
        self.indirect_labor_subtotal = ("indirect_labor_subtotal")
        self.direct_labor_total = ("direct_labor_total")
        self.indirect_labor_total = ("indirect_labor_total")
        self.classification = ("classification")
        self.name = ("name")
        self.hours_st = ("hours_st")
        self.hours_ot = ("hours_ot")
        self.base_rate_st = ("base_rate_st")
        self.base_rate_ot = ("base_rate_ot")
        self.hw_pension_rate_st = ("hw_pension_rate_st")
        self.hw_pension_rate_ot = ("hw_pension_rate_ot")
        self.base_labor_cost_st = ("base_labor_cost_st")
        self.base_labor_cost_ot = ("base_labor_cost_ot")
        self.direct_labor_rate_st = ("direct_labor_rate_st")
        self.direct_labor_rate_ot = ("direct_labor_rate_ot")
        self.direct_labor_cost_st = ("direct_labor_cost_st")
        self.direct_labor_cost_ot = ("direct_labor_cost_ot")
